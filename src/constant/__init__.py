...
CONTAINER_NAME: str = "lungxray"

BLOB_DATA_FOLDER: str = "data"
...
BENTOML_MODEL_NAME: str = "x_ray_model"

BENTOML_SERVICE_NAME: str = "x_ray_service"

BENTOML_ACR_IMAGE: str = "xray_bento_image"

AZURE_ACR_NAME : str = "lungdisease"
