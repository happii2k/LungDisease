...
class DataTransformation:
    ...
    def transforming_test_data(self)->transforms.Compose:
        logging.info(
            "Enter the transforming_testing_data method of Data transformation class"
        )
        try :
    ...
    def data_loader(
        ...
        try:
            ...
            train_data : Dataset = ImageFolder(
                os.path.join(self.data_transformation_config.train_data_path) , transform=train_transform
            )

            test_data : Dataset = ImageFolder(
                os.path.join(self.data_transformation_config.test_data_path) , transform= test_transform
            )
...
if __name__ =="__main__":
    data_transformation_config = DataTransformation(DataTransformationConfig() , DataIngestionArtifact)
